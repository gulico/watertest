...
public class FourFragment extends Fragment implements IShowdetailFrament{
    ...
    private void setData(int count, float range) {
        List<Entry> values = new ArrayList<>(iShowdetailDataPersenter.loadp((String) datapicker.getSelectedItem().toString()));
        LineDataSet dataSet = new LineDataSet(values, "总磷");
       ...
       //YAxis leftAxis = mChart.getAxisLeft();
        ...
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {//点击高亮时回调
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                highlight_data.setText("总磷 " + e.getY());
