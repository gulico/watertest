...
public class SevenFragment extends Fragment implements IShowdetailFrament{
    ...
    private void setData(int count, float range) {
        List<Entry> values = new ArrayList<>(iShowdetailDataPersenter.loadntu((String) datapicker.getSelectedItem().toString()));
        LineDataSet dataSet = new LineDataSet(values, "浊度");
    ...
    private void initChart() {
        ...
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {//点击高亮时回调
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                highlight_data.setText("浊度 " + e.getY());
