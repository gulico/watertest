...
public class FifthFragment extends Fragment implements IShowdetailFrament{
    ...
    private void setData(int count, float range) {
        List<Entry> values = new ArrayList<>(iShowdetailDataPersenter.loadconductivity((String) datapicker.getSelectedItem().toString()));
        LineDataSet dataSet = new LineDataSet(values, "电导率");
       ...
       // yLimitLine.setLineColor(Color.RED);
        ...
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {//点击高亮时回调
            ...
            public void onValueSelected(Entry e, Highlight h) {
                highlight_data.setText("电导率 " + e.getY());
