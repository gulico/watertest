...
public class SecondFragment extends Fragment implements IShowdetailFrament {
    ...
    private void setData(int count, float range) {
        Log.d(TAG, "setData: "+datapicker.getSelectedItem().toString());
        List<Entry> values = new ArrayList<>(iShowdetailDataPersenter.loadwater_temperature((String) datapicker.getSelectedItem().toString()));
