...
public class ThridFragment extends Fragment implements IShowdetailFrament{
    ...
    private void setData(int count, float range) {
        List<Entry> values = new ArrayList<>(iShowdetailDataPersenter.loadammonia_nitrogen((String) datapicker.getSelectedItem().toString()));
        LineDataSet dataSet = new LineDataSet(values, "氨氮");
    ...
    private void initChart() {
        ...
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {//点击高亮时回调
            ...
            public void onValueSelected(Entry e, Highlight h) {
                highlight_data.setText("氨氮 " + e.getY());
