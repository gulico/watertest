...
/**
 * Created by WXY on 2017/11/20.
 */

public class CommomDialog extends Dialog implements View.OnClickListener{
    private static final String TAG = "CommomDialog";
    //n private ScrollPickerView contentScroll;
    ...
    public CommomDialog(Context context,View view, OnCloseListener listener) {
        super(context);
    ...
    public CommomDialog setView(View view){//加载内容布局
        this.contentView = view;
        return this;
    }
    ...
    public interface OnCloseListener{
        void onClick(CommomDialog dialog, boolean confirm);
    }
